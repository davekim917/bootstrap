...
Unmet criteria → SendMessage to builder with file:line → builder fixes → re-review. Same 3-iteration retry limit as the Fix Loop below. Don't proceed to Stage 2 until ✅.

### Stage 2: Code Quality

After Stage 1 clears: well-structured? follows CLAUDE.md conventions? obvious perf issues? adequate error handling at boundaries? hardcoded values that should be configurable?
