...
from AGENTS.md/CLAUDE.md (co-located `.test.ts`, `__tests__/file.spec.ts`, top-level `tests/`, etc.).
...
2-4 sentences describing what to build. Cite the project skill or AGENTS.md/CLAUDE.md section this
...
(scope file, AGENTS.md/CLAUDE.md, domain skills). The plan specifies *what* to build; the builder decides *how*.
...
- `AGENTS.md/CLAUDE.md` — always (conventions, guardrails)
