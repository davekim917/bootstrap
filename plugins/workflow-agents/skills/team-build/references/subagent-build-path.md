...
Spawn a worker scoped to this group, with the builder prompt from
`references/builder-prompt-template.md` (see SKILL.md § Dispatch by Runtime for the per-runtime
spawn primitive).
...
- Well-structured? Follows AGENTS.md/CLAUDE.md conventions?
