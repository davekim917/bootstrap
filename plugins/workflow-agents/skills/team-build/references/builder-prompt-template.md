...
The lead fills this template for each builder before spawning it (see the skill's
§ Dispatch by Runtime for the per-runtime spawn primitive).
Replace all `[PLACEHOLDERS]` with actual content from the plan and AGENTS.md/CLAUDE.md.
...
**Tech stack:** [Language + Framework + DB from AGENTS.md/CLAUDE.md]
...
- [Guardrail 1 from AGENTS.md/CLAUDE.md Critical Guardrails section]
- [Guardrail 2]
- [Guardrail 3]
...
When your group is complete, report this back to the lead (see the skill's § Dispatch by Runtime for how workers report back on this runtime):
...
**What to fill in from AGENTS.md/CLAUDE.md:**
...
- Entire AGENTS.md/CLAUDE.md (only the excerpts above)
