...
**Sources:**
- AGENTS.md/CLAUDE.md behavioral rules (e.g., "no @imports")
- AGENTS.md/CLAUDE.md critical guardrails (e.g., "always use {{ ref() }}")
...
For each constraint in the brief:
  ...
  2. Source: Brief / AGENTS.md/CLAUDE.md / Implicit
...
After classifying all brief constraints:
  5. Scan AGENTS.md/CLAUDE.md for implicit constraints that apply to this design area
