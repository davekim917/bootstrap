...
description: >
  ...
  stage-by-stage findings, key learnings, and recommended updates to AGENTS.md/CLAUDE.md and skills.
...
**NOT output:** Code changes, skill rewrites, or AGENTS.md/CLAUDE.md edits (those are recommendations for the user to act on)
...
- **AGENTS.md/CLAUDE.md:** Which section, what change, why (cite the finding)
...
Be concrete: "Add to AGENTS.md/CLAUDE.md § Critical Guardrails: 'Always validate X before Y' — because /team-build Task B3 failed twice due to missing validation (see plan.md Task B3 acceptance criteria)."
...
- `AGENTS.md/CLAUDE.md` — to understand what rules exist that may need updating
