---
name: jony-ive
description: Premium UI/UX design audit and refinement skill inspired by Jony Ive and Steve Jobs. Focuses exclusively on visual design — hierarchy, whitespace, typography, color, alignment, motion, and accessibility — without touching application logic. Use when auditing app screens, elevating visual polish, enforcing design system consistency, or planning phased design improvements. Triggers on tasks involving UI review, design audits, visual refinement, spacing/layout fixes, or making an app feel premium and inevitable. Do not use for feature development, application logic, data modeling, API design, or any backend/infrastructure work.
---
...
- Flag inconsistency. Do not invent a third variation.
