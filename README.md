...
|---|---|---:|---|
| Claude Code | `bootstrap-workflow` | 5.0.6 | Claude-native workflow skills and safety gates |
| Codex / OpenCode | `bootstrap-workflow-agents` | 2.0.6 | Runtime-neutral workflow skills and safety gates |
