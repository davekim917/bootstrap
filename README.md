...
| Claude Code / Codex | `analytics-verify` | 1.2.1 | Claim ledger, check script and independent-verifier loop for analytics and research deliverables, with an always-on nudge |
